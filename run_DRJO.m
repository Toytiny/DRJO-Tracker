...
%   Learning parameters
params.output_sigma_factor =1/20;		% 1/20 standard deviation of the desired correlation output (proportional to target)
params.local_nums=15;
params.beta=0.5;
...
params.num_sv =13;
params.num_arc=13;
params.learning_rate_size=0.015; %0.014
params.sv_sigma_factor =1.5; %1.5
params.arc_sigma_factor=1.5;
params.size_model_factor = 1;
params.sv_step=1.03;
params.arc_step=1.02^2;
params.size_lambda = 1e-2;
